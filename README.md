...
| # | Titlu | Tehnologii |
|---|-------|------------|
| Lab 1 | Extension Methods si Delegates | C#, Visual Studio, Console App |
| Lab 2 | HTTP si fundamente Web API | HTTP, REST, ASP.NET Core |
| Lab 3 | LINQ si DataAnnotations | LINQ, `System.ComponentModel.DataAnnotations` |
