...
public static class SeedData
{
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        // Lab13: foloseste EnsureCreated() pentru ambele variante - nu pastram migrari
        // separate per provider. Pentru proiectul tau in productie, foloseste:
        ...
        // Seed tag-uri si asociere la primul articol
