...
public class ArticlesController : Controller
{
    ...
    // TODO Lab 10 (Ex. 1): Adaugati field private readonly ITagService _tagService;
    private readonly IWebHostEnvironment _env;

    private const int PageSize = 5;

    // TODO Lab 10 (Ex. 1): Adaugati ITagService tagService la constructor + asignati _tagService = tagService;
    ...
    // GET: /Articles/Create — necesită autentificare
    [Authorize]
    ...
    // POST: /Articles/Create — necesită autentificare
    [Authorize]
    [HttpPost]
    ...
    public async Task<IActionResult> Create(CreateArticleViewModel viewModel, CancellationToken cancellationToken)
    {
        ...
        // TODO Lab 10 (Ex. 1): Atasati tag-urile selectate la articol
        // - if (viewModel.SelectedTagIds.Any()) { var tags = await _tagService.GetByIdsAsync(viewModel.SelectedTagIds, cancellationToken); article.Tags = tags; await _articleService.UpdateAsync(article, cancellationToken); }
        // - sau, alternativ, atribuiti tag-urile inainte de AddAsync (atunci AddAsync trebuie sa stie sa salveze relatia)

        return RedirectToAction(nameof(Index));
    }

    // GET: /Articles/Edit/5 — doar author sau admin
    [Authorize]
    ...
    // POST: /Articles/Edit/5 — doar author sau admin
    [Authorize]
    [HttpPost]
    [ValidateAntiForgeryToken]
    ...
    // GET: /Articles/Delete/5 — doar author sau admin
    [Authorize]
    ...
    // POST: /Articles/Delete/5 — doar author sau admin
    [Authorize]
    ...
    private async Task LoadDropdownsAsync(CreateArticleViewModel viewModel, CancellationToken cancellationToken)
    {
        ...
        // TODO Lab 10 (Ex. 1): Populati viewModel.AvailableTags din _tagService.GetAllAsync
        // - var tags = await _tagService.GetAllAsync(cancellationToken);
        // - viewModel.AvailableTags = tags.Select(t => new SelectListItem { Value = t.Id.ToString(), Text = t.Name }).ToList();
    }
}
