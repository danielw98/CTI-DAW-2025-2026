...
public static class SeedData
{
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        // Seed roles
        // "Vizitator" nu e un rol Identity — e pur și simplu un utilizator neautentificat.
        // Rolurile stocate în baza de date sunt doar pentru utilizatorii autentificați.
        ...
        if (!context.Categories.Any())
        {
            ...
            // TODO Lab 10 (Ex. 1): Seed cateva tag-uri (5+) si asociati primul articol cu doua tag-uri
            // - guard cu if (!context.Tags.Any()) ca sa fie idempotent
            // - exemple: "C#", "Web", "Tutorial", ".NET", "Database"
            // - context.Tags.AddRange(...) + await context.SaveChangesAsync();
            // - dupa ce se creeaza articolele, primul articol primeste Tags = [C#, .NET]
