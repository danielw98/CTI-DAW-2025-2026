...
// File sink dezactivat in starter ca sa nu scrie logs/newsportal-*.txt la fiecare request
// (acumulare zilnica + writes constante = uzura SSD pe dev box). Console sink ramane activ.
// Pentru a-l reactiva, decomentati WriteTo.File(...) si adaugati path la .gitignore.
